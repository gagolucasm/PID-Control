...
int main() {
    ...
    //pid.Init(.18, 0.01, .3);  for  30
    //pid.Init(.1, 0.00, .3);   for  40
    //pid.Init(.035, 0.0001, .12) for 50;   
    pid.Init(.035, 0.0001, .12);
    pid_speed.Init(0.4, .004, 0);
        ...
        if (length && length > 2 && data[0] == '4' && data[1] == '2') {
            ...
            if (s != "") {
                ...
                if (event == "telemetry") {
                    ...
                    std::cout << "P: " << pid.p_error << "  I: " << pid.i_error << "  D: " << pid.d_error << " Total: " << pid.TotalError() << std::endl;
                    std::cout << "---------------------------------------------" << std::endl;
